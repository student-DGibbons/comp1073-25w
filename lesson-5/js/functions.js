...
let newText = text.replace("awesome", "cool");
console.log(newText);
...
function makeH1Red(){
    ...
    // CSS likes string values (remember for lab)
    h1.style.color = 'red';
}

//If you don't have the brackets after the function name, you will reference the function
//but not call it, which can be helpful in some instances
makeH1Red();
